...
class DataTransformation:
    ...
    def get_data_transformer(self):
        try:
            ...
            #save the book names object for web app
            ...
            logging.info(f"Saved the book_names serializaion object to {self.data_validation_config.serialized_objects_dir}")

            #save the book pivot for web app
            os.makedirs(self.data_validation_config.serialized_objects_dir,exist_ok=True)
            pickle.dump(book_pivot,open(os.path.join(self.data_validation_config.serialized_objects_dir,"book_pivot.pkl"),'wb'))
            logging.info(f"Saved the book_pivot serialization object to {self.data_validation_config.serialized_objects_dir}")
